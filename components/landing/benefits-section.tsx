...
const benefits = [
  ...
  },
  {
    ...
    features: ["Gana lo que quieras", "multiplica tus ingresos hasta 10X", "Genera ingresos adicionales"]
  },
  {
    icon: Users,
    title: "Comunidad de Apoyo",
    description: "Nunca estarás solo. Tendrás un equipo que te guía y celebra tus victorias.",
    features: ["Mentorías semanales", "Grupo de WhatsApp activo", "Eventos en vivo"]
  },
  {
    icon: GraduationCap,
    title: "Formación Continua",
    description: "Acceso a entrenamientos exclusivos que te convertirán en un líder.",
    features: ["Cursos premium incluidos", "Conferencias internacionales", "Desarrollo personal y profesional"]
  },
  {
    icon: Heart,
  ...
  },
  {
    ...
    features: ["Presencia en varios países", "Sin límites geográficos"]
  }
];
